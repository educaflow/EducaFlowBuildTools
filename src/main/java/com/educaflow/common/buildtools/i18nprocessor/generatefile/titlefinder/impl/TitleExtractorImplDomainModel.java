...
public class TitleExtractorImplDomainModel implements TitleExtractor {
    ...
    public List<String> getTitlesFromFile(Path domainFile) {
        ...
        //Campos del dominio
        List<Element> fields=XMLUtil.getElementsFromEvaluateXPath("//entity/*[@name][local-name()!='finder-method'][local-name()!='entity-listener'][local-name()!='index'][local-name()!='unique-constraint']", document.getDocumentElement(),true);
